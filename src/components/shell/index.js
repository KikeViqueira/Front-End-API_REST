  ...
  return (
    <section className="overflow-hidden min-h-screen flex flex-col justify-between">
      ...
      >
        ...
        <form
          autoComplete="off"
          className="max-w-lg group flex-1 relative overflow-hidden"
          id="searchForm"
        >
          <Input
            name="search"
          ...
          />
          <button
            className={`absolute right-4 top-3 bottom-3 flex items-center px-2 pt-px 
      ...
      <aside
        className={`fixed top-16 left-0 w-full h-screen z-40
      ...
      >
        <div className="w-full bg-white">
          <MovieList
            ...
            itemClassName="hover:translate-y-4"
            query={{ filter: tryParse(query) }}
          />
        </div>
        <footer
          className={`w-full flex bg-white justify-center p-2 cursor-pointer transition transform hover:-translate-y-2`}
        >
          <Button
            type="reset"
            onClick={close}
      ...
      <main
        className={`relative mt-16 overflow-x-hidden w-full min-h-full flex-1 max-w-full ${className}`}
      >
        {children}
      </main>
  ...
  return (
    <Menu>
      {({ open }) => (
        <>
          <Menu.Button
            className={`flex flex-row justify-end items-center h-12 space-x-4 overflow-hidden focus:outline-none`}
          >
          ...
          >
            <Menu.Items
              static
              className={`shadow mt-16 w-40 bg-white rounded border-gray-500 outline-none divide-y divide-gray-200`}
            >
              <div className="py-1">
                <Menu.Item>
                  <Link
                    className={`flex items-center w-full h-10 text-sm leading-5 text-left transition text-gray-700 transition-all group
              ...
              <div className="py-1">
                <Menu.Item>
                  ...
                  >
                    <span className="block bg-gradient-to-br from-pink-500 to-yellow-500 via-red-500 w-0 h-full group-hover:w-2" />
                    <LogoutIcon className="h-4 w-4 mx-4 text-gray-500" />
                    <span>Salir</span>
                  </button>
                </Menu.Item>
              </div>
